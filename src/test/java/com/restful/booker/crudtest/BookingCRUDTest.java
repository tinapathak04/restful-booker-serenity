...
public class BookingCRUDTest {
    ...
    static String firstname = "Raghav" + TestUtils.getRandomValue();
    static String lastname = "Modi" + TestUtils.getRandomValue();
    static int totalprice = Integer.parseInt(1 + TestUtils.getRandomValue());
    static boolean depositpaid = true;
    static String additionalneeds = "Eng.study";
    static String token;
    static int id;
    ...
    public void test002() {
        ...
        bookingdates.setCheckin("2024-12-01");
        bookingdates.setCheckout("2025-12-01");
    ...
    public void test005() {
        ...
        Assert.assertThat(update, hasValue("Eng.study"));
    }
